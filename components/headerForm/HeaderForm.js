...
const HeaderForm = () => {
  ...
  const text = {
    init: {
      h1: "Testez votre éligibilité aux aides 2023 encadré par l’état: MaPrimeRenov’!",
      h3: "80% de vos travaux d’économie d’énergie pris en charge.",
    },
    CAH: {
      h1: "Validez votre éligibilité aux subventions 2023 soutenues par l'État : MaPrimeRenov' !",
