    ...
    return (
        <div className={styles.container}>
            <div className={styles.textContainer}>
                <div className={styles.p}><span className={styles.span}>MaPrimeRénov&lsquo;</span> c’est <span className={styles.span}>+644 000 primes</span> accordé par <span className={styles.span}>l’état</span></div>
