...
const MultiForm = (props) => {
  const entreprise = props.entreprise || null;
  ...
  const handleContainer = () => {
    switch (value) {
      case 1:
        return (
          <ContainerOne
            valid={(e) => setStepOne(e)}
            value={(e) => setProspect({ ...propsect, type: e })}
          />
        );
      ...
      case 2:
        return (
          <ContainerTwo
            valid={(e) => setStepTwo(e)}
            value={(e) => setProspect({ ...propsect, years: e })}
          />
        );
      ...
      case 3:
        return (
          <ContainerThree
            valid={(e) => setStepThree(e)}
            value={(e) => setProspect({ ...propsect, size: e })}
          />
        );
      ...
      case 4:
        return (
          <ContainerFour
            valid={(e) => setStepFour(e)}
            value={(e) => setProspect({ ...propsect, heater: e })}
          />
        );
      ...
      case 5:
        return (
          <ContainerFive
            ...
            setPompeAChaleurClim={(e) =>
              setProspect({ ...propsect, pompeAChaleurClim: e })
            }
            setChauffage={(e) => setProspect({ ...propsect, chauffage: e })}
            setSolaireChauffeEau={(e) =>
              setProspect({ ...propsect, solaireChauffeEau: e })
            }
          />
        );
      ...
      case 6:
        return (
          <ContainerSix
            valid={(e) => setStepSix(e)}
            value={(e) => setProspect({ ...propsect, status: e })}
          />
        );
      ...
      case 7:
        return (
          <ContainerEleven
            valid={(e) => setStepEleven(e)}
            value={(e) => setProspect({ ...propsect, zipCode: e })}
          />
        );
      ...
      case 8:
        return (
          <ContainerTen
            valid={(e) => setStepTen(e)}
            value={(e) => setProspect({ ...propsect, nbrFamily: e })}
          />
        );
            ...
            value={(e) => {
              e !== null
                ? setProspect({
                    ...
                    revenusColor: e[0],
                    revenusMin: e[1],
                    revenusMax: e[2] !== undefined ? e[2] : null,
                  })
                : null;
            }}
          />
  ...
  useEffect(() => {
    switch (value) {
      ...
      case 5:
        if (
          propsect.chauffage !== false ||
          propsect.fenetre !== false ||
          propsect.isolation !== false ||
          propsect.vmc !== false ||
          propsect.pompeAChaleurClim !== false ||
          propsect.solaireChauffeEau !== false
        ) {
          setDisable(false);
        } else {
          setDisable(true);
      ...
      case 7:
        if (
          propsect.zipCode !== "" &&
          zipCodeRegex.test(propsect.zipCode) === true
        ) {
      ...
      case 9:
        propsect.revenusColor !== "" && propsect.revenusColor !== null
          ? setDisable(false)
          : setDisable(true);
        break;
  ...
  return (
    <div className={styles.multiFormContainer} id="form">
      ...
      <div className={styles.topContainer}>
        ...
        >
          <div
            className={styles.avancement}
            style={
              value === 8
                ? { borderRadius: "20px 0px 0 0", width: `${progressValue}%` }
                : { width: `${progressValue}%` }
            }
          >
