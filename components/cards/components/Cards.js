...
const Cards = (props) => {
  ...
  return (
    <div className="h-80 relative w-80 lg:max-w-[300px] rounded-xl bg-indigo-600 z-10 flex flex-col justify-around p-4 mb-10 lg:mb-0">
      <div
      ...
      <h3 className="w-full mx-auto md:text-6xl text-4xl text-gray-100">
        {title !== undefined ? title : null}
      </h3>
      <h4 className={styles.text}>{text !== undefined ? text : null}</h4>
      <div className="w-full h-16 rounded-md flex justify-center items-center px-3">
