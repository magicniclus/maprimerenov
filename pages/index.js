    ...
    <LayoutClassicPage  >
      <main className={styles.main}>
        <div className={styles.topContent}>
          ...
          <p className={styles.p}><span className={styles.span}>MaPrimeRénov'</span> permet de <span className={styles.span}>financer</span> les travaux d'<span className={styles.span}>isolation</span>, de <span className={styles.span}>chauffage</span>, de <span className={styles.span}>ventilation</span> ou d'<span className={styles.span}>audit énergétique</span> d'une <span className={styles.span}>maison individuelle</span> ou d'un <span className={styles.span}>appartement</span> en habitat collectif. <br /><br />De l’analyse de vos besoins, estimation des <span className={styles.span}>aides</span>, gestions du dossier, soursing des entreprises et gestion des <span className={styles.span}>travaux</span> jusqu’à la réception de votre <span className={styles.span}>prime</span>, chez <span className={styles.span}>MaPrimeRenov-info.org</span>, nous vous accompagnons pour tout.</p>
